export const fr = {
  ...
  "ws.coll.kbd_hint": "↑↓ entité · ←→ historique",
  ...
  "auth.authorize.labelLabel": "Étiquette de connexion",
  "auth.authorize.labelOptional": "(facultatif)",
  "auth.authorize.labelPlaceholder": "par ex. projet huozi, dépôt Dot",
  "auth.authorize.labelHint": "Permet de distinguer plusieurs connexions du même client dans Agents connectés.",
  ...
  "theme.confirm.experimental": "Style néo-brutaliste — expérimental, à fort impact visuel.",
  ...
  "csv.rowDetail.openHint": "Espace ligne · Entrée éditer",
