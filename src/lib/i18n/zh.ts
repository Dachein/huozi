export const zh = {
  ...
  "auth.authorize.labelLabel": "连接标签",
  "auth.authorize.labelOptional": "（可选）",
  "auth.authorize.labelPlaceholder": "例如：huozi project、Dot 项目",
  "auth.authorize.labelHint": "用于在「已连接 Agent」中区分同一客户端的多个连接。",
