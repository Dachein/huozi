export const ja = {
  ...
  "ws.coll.selectToRead": "詳細を見るには選択",
  ...
  "auth.authorize.labelLabel": "接続ラベル",
  "auth.authorize.labelOptional": "（任意）",
  "auth.authorize.labelPlaceholder": "例：huozi プロジェクト、Dot リポジトリ",
  "auth.authorize.labelHint": "「接続済みエージェント」で同じクライアントの複数接続を区別するために使われます。",
