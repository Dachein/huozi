...
export function FolderSettingsActions({
  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="flex flex-wrap items-center gap-2">
        {!isProject && !isArchived && (
          <button
            ...
            className="inline-flex items-center gap-1 rounded-md border border-emerald-500/40 bg-emerald-50 px-3 py-1.5 text-xs font-medium text-emerald-900 transition-colors hover:bg-emerald-100 disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        {isProject && !isArchived && (
          <button
            ...
            className="inline-flex items-center gap-1 rounded-md border border-amber-500/40 bg-amber-50 px-3 py-1.5 text-xs font-medium text-amber-900 transition-colors hover:bg-amber-100 disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        {isArchived && (
          <button
            ...
            className="inline-flex items-center gap-1 rounded-md border border-blue-500/40 bg-blue-50 px-3 py-1.5 text-xs font-medium text-blue-900 transition-colors hover:bg-blue-100 disabled:opacity-50 disabled:cursor-not-allowed"
          >
      ...
      {error && (
        <div className="rounded-md border border-red-500/40 bg-red-50 px-3 py-2 text-xs text-red-900">
